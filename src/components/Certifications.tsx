...
const CertificationCard = ({ certification, isHovered, onHover, onLeaveHover, index }: {
  ...
  return (
    <div 
      className={`certification-card p-8 group transition-all duration-700 ease-out reveal-stagger ${
    ...
    >
      ...
      <div className="flex items-center mb-8">
        <div className="relative">
          ...
          <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-purple-500 to-cyan-400 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
            <Star className="w-3 h-3 text-white" />
          </div>
        </div>
        <div className="flex-1">
          <h3 className="text-xl font-bold text-white mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-cyan-400 transition-all duration-500">
            {certification.title}
          </h3>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 mb-6 border-l-4 border-gradient-to-b from-purple-500 to-cyan-400 group-hover:bg-white/10 transition-all duration-500">
        <div className="grid grid-cols-1 gap-3">
          <div className="flex items-center gap-3">
            <div className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></div>
            <span className="text-sm text-gray-300">
              <span className="text-cyan-400 font-semibold">Issued:</span> {certification.date}
            </span>
          </div>
          {certification.credential && (
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-300">
                <span className="text-purple-400 font-semibold">ID:</span> {certification.credential}
              </span>
            </div>
          )}
        </div>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 via-transparent to-cyan-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl pointer-events-none"></div>
    </div>
  );
};
